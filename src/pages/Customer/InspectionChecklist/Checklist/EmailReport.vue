...
<script>
import { ref, defineAsyncComponent, onMounted, reactive, getCurrentInstance } from "vue";
...
export default {
  ...
  setup(props) {
    ...
    const setValidationErrors = app.appContext.config.globalProperties.$setValidationErrors;
    const clearValidationErrors = app.appContext.config.globalProperties.$clearValidationErrors;
    ...
    const submitForm = () => {
        ...
        if(emailReport.value.user_id === null && emailReport.value.email === ""){
            Qnotify({
